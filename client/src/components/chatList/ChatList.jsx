...
const ChatList = () => {
  ...
  const toggleSidemenuOpen = () => {
    setIsSidemenuOpen((e) => !e);
  };

  return (
    <div className={`menu ${isSidemenuOpen ? "open" : "closed"}`}>
      <aside className="sidemenu">
        <div className="top-sidemenu">
          <Link to="/" className="logo">
            ...
            <span className="title">Reflection AI</span>
          </Link>
        ...
        <div className="bottom">
          ...
          <div className="upgrade">
            <button className="texts">
              <span>Upgrade to Reflection AI Pro</span>
